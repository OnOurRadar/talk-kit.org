    ...
    <div class="site" id="page">
        ...
        <div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
            ...
            <div class="container-fluid text-center bg-dark text-white">
                <a class="skip-link sr-only sr-only-focusable" href="#info"><?php esc_html_e('Skip to Introduction', 'understrap'); ?></a>
                <a class="skip-link sr-only sr-only-focusable" href="#video"><?php esc_html_e('Skip to Video Course', 'understrap'); ?></a>
                <a class="skip-link sr-only sr-only-focusable" href="#guides"><?php esc_html_e('Skip to Guides', 'understrap'); ?></a>
                <a class="skip-link sr-only sr-only-focusable" href="#stories"><?php esc_html_e('Skip to Case Studies', 'understrap'); ?></a>

            </div>
            <div class="bg-blue lead font-weight-normal">
                <nav class="navbar container navbar-expand-lg navbar-light py-4">
